...
<div class="section-title">
    <h4 class="text-secondary text-uppercase" style="letter-spacing: 5px;">Hasil</h4>
    <h1 class="display-4">{{$hasil->nama_penyakit}}</h1>
</div>
...
<div class="card">
	<div class="card-body">
		<a href="{{url('cek',$detail->history_id)}}/cetak" target="_blank" class="btn btn-dark float-right"><i class="fa fa-print"></i> Cetak Hasil</a>
